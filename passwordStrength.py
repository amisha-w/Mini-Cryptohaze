...
with open("dictionary\\english", 'r') as f:
...
class passwordstrength:
    ...
    def __table_print(self, title, count, value):        
        ...
        if value>0:
        	...
        	value = str(value)
        ans.append([title,count,value])
        # print ("{title:40s}{count:13s}{value:4s}".format(**locals()))
    ...
    def __lower_upper_case_score(self):
        ...
        n_upper = self.__chars_of_type("ABCDEFGHIJKLMNOPQRSTUVWXYZ")
        n_lower = self.__chars_of_type("abcdefghijklmnopqrstuvwxyz")
    ...
    def __letters_only_score(self):
        letter_count = self.__chars_of_type("abcdefghijklmnopqrstuvwxyz" + "ABCDEFGHIJKLMNOPQRSTUVWXYZ")
    ...
    def __consecutive_case_score(self):
        ...
        self.__table_print('consecutive upper-case letters',
                           char_types["ABCDEFGHIJKLMNOPQRSTUVWXYZ"],
                           -2*char_types["ABCDEFGHIJKLMNOPQRSTUVWXYZ"])
